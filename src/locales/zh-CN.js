export default {
  ...
  'menu': '菜单',
  'menu.accounts': '账户管理',
  'menu.accounts.list': '账户列表',
  'menu.accounts.editAccount': '编辑账户',
  'menu.order': '订单管理',
  'menu.order.dayOrder': '日订单',
  'menu.order.monthOrder': '月订单',
  'menu.products': '商品管理',
  ...
  'app.forms.add.title': '添加账户',
  'app.forms.edit.title': '编辑账户',
